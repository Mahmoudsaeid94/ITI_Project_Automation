...
import media.ScreenRecordManager;
import media.ScreenshotsManager;
...
import java.io.File;
    ...
    public class TestNGListeners implements ISuiteListener, IExecutionListener, IInvokedMethodListener, ITestListener {
        ...
        public void beforeInvocation(IInvokedMethod method, ITestResult testResult) {
            LogsManager.info("Is UITest: " + testResult.getInstance().getClass().isAnnotationPresent(UITest.class));
            LogsManager.info("Class name: " + testResult.getInstance().getClass().getName());
            if (method.isTestMethod()) {
                if (testResult.getInstance().getClass().isAnnotationPresent(UITest.class) ||
                        testResult.getInstance().getClass().getSuperclass().isAnnotationPresent(UITest.class))
                {
